...
import { Check, X, Plus, Trash2, Image as ImageIcon, Sparkles, HelpCircle } from 'lucide-react';
...
export const ProductEditForm: React.FC<ProductEditFormProps> = ({ productId }) => {
  const { stagedProducts, saveProductDraft, setEditingProductId, formatPrice } = useStore();
  ...
  return (
    <form onSubmit={handleSave} className="space-y-8 max-w-7xl mx-auto pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-6 space-y-6 bg-white p-6 border border-neutral-200 rounded-lg">
          <h2 className="text-[12px] uppercase tracking-wider font-bold text-neutral-900 border-b border-neutral-100 pb-2">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border border-neutral-300 rounded-md px-3 py-2 text-sm focus:outline-black font-medium"
          ...
          <div>
            ...
            <div className="flex items-center">
              <span className="text-neutral-400 text-xs px-2.5 py-2 bg-neutral-50 border border-r-0 border-neutral-300 rounded-l-md font-mono">
                /product/
              </span>
              <input
                type="text"
                ...
                className="w-full border border-neutral-300 rounded-r-md px-3 py-2 text-sm focus:outline-black font-mono text-neutral-800"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full border border-neutral-300 rounded-md px-3 py-2 text-xs focus:outline-black bg-white"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full border border-neutral-300 rounded-md px-3 py-2 text-xs focus:outline-black bg-white font-medium"
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-neutral-300 rounded-md px-3 py-2 text-xs focus:outline-black"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full border border-neutral-300 rounded-md px-3 py-2 text-xs focus:outline-black leading-relaxed"
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5 mb-2">
              {form.tags.map(tag => (
                <span
                  key={tag}
                  className="inline-flex items-center gap-1.5 bg-neutral-100 text-neutral-800 text-[10px] font-medium px-2.5 py-1 rounded-full"
                >
                  <span>{tag}</span>
                  <button
                    type="button"
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 border border-neutral-300 rounded-md px-3 py-1.5 text-xs focus:outline-black"
                placeholder="e.g. Architectural, Numbered Edition..."
              />
              <button
                type="button"
                onClick={handleAddTag}
                className="px-3 py-1.5 text-[10px] uppercase font-semibold bg-neutral-100 hover:bg-neutral-200 rounded-md transition-colors"
              >
                Add Tag
              </button>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {form.colours.map(c => (
                <span
                  key={c.id}
                  className="inline-flex items-center gap-2 border border-neutral-200 bg-white px-2.5 py-1 rounded-full text-[10px] shadow-2xs"
                >
                  <span
                  ...
                  <button
                    ...
                    className="text-neutral-400 hover:text-black ml-0.5"
                  >
                    <X className="w-3 h-3" />
                  </button>
                </span>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-8 h-8 p-0.5 border border-neutral-300 rounded-md cursor-pointer"
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="bg-white p-6 border border-neutral-200 rounded-lg space-y-5">
            <h2 className="text-[12px] uppercase tracking-wider font-bold text-neutral-900 border-b border-neutral-100 pb-2">
              Imagery & 360° Turntable Gallery
            </h2>

            {/* Grid & Hover Image Slots */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Card Image */}
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label className="text-[10px] uppercase tracking-wider font-semibold text-neutral-700">
                    Card Image (Grid tile)
                  </label>
                  {form.cardImage && (
                    <button
                      type="button"
                      onClick={() => setForm({ ...form, cardImage: '' })}
                ...
                <div className="aspect-square bg-neutral-50 border border-dashed border-neutral-300 rounded-md overflow-hidden flex items-center justify-center relative mb-2">
                  {form.cardImage ? (
                ...
                <input
                  ...
                  className="w-full border border-neutral-300 rounded px-2.5 py-1 text-[11px] font-mono focus:outline-black"
                />
              </div>
              ...
              <div>
                ...
                <div className="aspect-square bg-neutral-50 border border-dashed border-neutral-300 rounded-md overflow-hidden flex items-center justify-center relative mb-2">
                  {form.hoverImage ? (
                    <img src={form.hoverImage} alt="Hover preview" className="w-full h-full object-cover" />
                  ) : (
                    <div className="text-center p-3 text-neutral-400">
                      <ImageIcon className="w-6 h-6 mx-auto mb-1 stroke-1" />
                      <span className="text-[10px]">No hover image</span>
                    </div>
                  )}
                </div>
                <input
            ...
            {/* Product Page Gallery (Feeds PDP drag-to-rotate turntable) */}
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <div>
                  <label className="text-[10px] uppercase tracking-wider font-semibold text-neutral-700">
                  ...
                  <p className="text-[10px] text-neutral-400">
                    Sequential images power the storefront PDP's Drag-to-Rotate 360° viewer.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 sm:grid-cols-6 gap-2 mt-2">
                {form.galleryImages.map((url, idx) => (
                  <div key={idx} className="group relative aspect-square bg-neutral-100 border border-neutral-200 rounded overflow-hidden">
                    ...
                    <button
                      ...
                      className="absolute top-0.5 right-0.5 p-1 bg-black/70 text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                    >
                      <X className="w-2.5 h-2.5" />
                    </button>
                  </div>
                ...
                <button
                  ...
                  className="aspect-square border border-dashed border-neutral-300 hover:border-black rounded flex flex-col items-center justify-center text-neutral-400 hover:text-black transition-colors"
                >
              ...
              {showAddGalleryInput && (
                <div className="mt-3 flex gap-2 p-2 bg-neutral-50 border border-neutral-200 rounded">
                  <input
                    type="text"
                    value={newGalleryUrl}
                    onChange={e => setNewGalleryUrl(e.target.value)}
                    placeholder="Enter image URL for 360° rotation..."
                    className="flex-1 bg-white border border-neutral-300 px-2.5 py-1 text-[11px] font-mono rounded"
                  />
                  <button
                    type="button"
                    onClick={() => handleAddGalleryImage(newGalleryUrl)}
                    className="px-3 py-1 bg-black text-white text-[10px] uppercase tracking-wider rounded font-medium"
                  >
                    Add
                  </button>
                  <button
          ...
          {/* Sizes, Pricing, and Weight Table */}
          <div className="bg-white p-6 border border-neutral-200 rounded-lg space-y-4">
            <div className="flex items-center justify-between border-b border-neutral-100 pb-2">
              <div>
                ...
                <p className="text-[10px] text-neutral-400 mt-0.5 flex items-center gap-1">
                  ...
                  <span>Weight fills in automatically from dimensions: width × depth × 0.0085 kg</span>
                </p>
              </div>
              ...
              <button
                ...
                className="text-[11px] font-semibold text-black hover:underline uppercase tracking-wider"
              >
                + Add size
              </button>
            </div>
                    ...
                    <tr key={size.id || idx}>
                      <td className="py-2 pr-2">
                        <input
                          ...
                          className="w-full border border-neutral-200 rounded px-2 py-1 text-[11px] font-sans"
                        />
                      </td>
                      <td className="py-2 pr-2 w-20">
                        <input
                          ...
                          className="w-full border border-neutral-200 rounded px-2 py-1 text-[11px]"
                        />
                      </td>
                      <td className="py-2 pr-2 w-20">
                        <input
                      ...
                      <td className="py-2 pr-2 w-20 text-neutral-600">
                        <span className="px-2 py-1 bg-neutral-50 rounded block text-center">
                          {size.weight} kg
                        </span>
                      </td>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-neutral-300 rounded px-3 py-1.5 text-xs font-mono"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-neutral-300 rounded px-3 py-1.5 text-xs font-mono text-neutral-600"
                />
              </div>
          ...
          <div className="bg-white p-6 border border-neutral-200 rounded-lg space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-neutral-300 rounded px-3 py-1.5 text-xs focus:outline-black"
                placeholder="e.g. Monolith Travertine Console — FORMA Studio"
              />
            </div>
