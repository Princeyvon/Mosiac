  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-1 text-[11px] uppercase tracking-widest font-normal text-black hover:opacity-60 transition-opacity py-1 px-1.5 focus:outline-none"
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-64 bg-white border border-black/10 shadow-xl z-50 text-black">
          {/* Search box */}
